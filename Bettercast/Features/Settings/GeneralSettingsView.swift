...
struct GeneralSettingsView: View {
    ...
    private var hyperSubtitle: String {
        ...
        if settings.hyperKeyReplacesGlyph {
            text += " Hyper Key shortcuts will be shown in Bettercast with ✦."
        }
        if hyperTap.status == .needsAccessibility {
            text += " Bettercast needs Accessibility access to remap keys."
        }
        return text
    }
        ...
        SettingsPane(
            ...
            SettingsCard(header: "Search") {
                SettingsRow(
                    ...
                    subtitle:
                        "Bettercast privately learns which results you choose for each query. Reset all learned choices to restore the default order.",
            ...
            SettingsCard(header: "General") {
                ...
                SettingsRow(
                    ...
                    subtitle:
                        "Keep the Bettercast icon in the menu bar. Shortcuts still work when hidden.",
