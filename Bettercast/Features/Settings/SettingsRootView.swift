...
extension Notification.Name {
    ...
    static let bettercastSelectSettingsTab = Notification.Name("BettercastSelectSettingsTab")
}
...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .frame(maxWidth: .infinity, maxHeight: .infinity)
        .onReceive(NotificationCenter.default.publisher(for: .bettercastSelectSettingsTab)) { note in
