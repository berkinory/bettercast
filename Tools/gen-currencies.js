#!/usr/bin/env node
// Generate Bettercast/Core/Calculator/CurrencyData.generated.swift.
//
...
async function main() {
  ...
  const out = path.resolve(__dirname, "..", "Bettercast/Core/Calculator/CurrencyData.generated.swift");
