...
struct OnboardingView: View {
    ...
    private var subtitle: String {
        ...
        case 1: "Let Opencast paste items back into the app you were using."
    ...
    private var readyMessage: String {
        if let caps = hotKeys.binding(for: .togglePalette)?.keycaps {
            return "Press \(caps.joined()) anytime to start using Opencast."
        }
        return "Opencast is ready. Set a shortcut in Settings to summon it."
    }
    ...
    private var shortcutStep: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.md) {
            SettingsSection {
                SettingsControlRow(
                    title: "App Launcher",
                    subtitle: "Press this shortcut to open Opencast.",
        ...
        VStack(alignment: .leading, spacing: Theme.Spacing.md) {
            SettingsSection {
                SettingsControlRow(
                    title: "Accessibility",
                    subtitle:
                        "Without it Opencast can still copy, but it can't paste a clipboard or emoji item back into the app you were using.",
