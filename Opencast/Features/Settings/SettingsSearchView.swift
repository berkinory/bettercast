...
enum SettingsSearchCatalog {
    static let staticItems: [SettingsSearchItem] = [
        ...
        item(
            ...
            detail: "Open Opencast as a slim search bar.", section: "Appearance",
        ...
        item(
            ...
            detail: "Start Opencast when you log in.", section: "General",
            keywords: ["startup", "boot", "automatic", "login item"], image: "power",
            tint: .green
        ),
        item(
            .showInMenuBar, tab: .general, title: "Show in Menu Bar",
            detail: "Keep the Opencast icon visible in the menu bar.", section: "General",
        ...
        item(
            ...
            detail: "Choose apps Opencast never records from.", section: "Privacy",
        ...
        item(
            ...
            detail: "Allow Opencast to paste into the previous app.", section: "Permissions",
