...
/// What Opencast remembers about each window it has moved: the frame to restore, the frame it was left
...
struct WindowActionMemory<Key: Hashable> {
    struct Record: Equatable, Sendable {
        /// Where the window was before Opencast first touched it.
