...
- **No bloat.** Bettercast stays small on purpose — quality over quantity. A clean patch still gets
...
- [`Core/Theme.swift`](Bettercast/Core/Theme.swift) tokens only. Read [`docs/ui.md`](docs/ui.md) before
