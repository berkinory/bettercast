...
Check existing [issues](https://github.com/berkinory/opencast/issues) and
[pull requests](https://github.com/berkinory/opencast/pulls) first.
...
- **No bloat.** Opencast stays small on purpose — quality over quantity. A clean patch still gets
...
- [`Core/Theme.swift`](Opencast/Core/Theme.swift) tokens only. Read [`docs/ui.md`](docs/ui.md) before
...
macOS version, Opencast version, steps, expected vs actual. A recording beats a paragraph.
